...
public class Prihod_Fragment extends Fragment {

    private RecyclerViewModel recyclerViewModel;
    private RecyclerView recyclerView;
    private static int id = 101;

    private FinansijaAdapter finansijaAdapter;

  public Prihod_Fragment(){
      super(R.layout.activity_recycler);
  }
    ...
    private void initView() {
        recyclerView = getView().findViewById(R.id.listRv);
    ...
    private void initRecycler() {
        finansijaAdapter = new FinansijaAdapter(new Differ(), finansija -> {
