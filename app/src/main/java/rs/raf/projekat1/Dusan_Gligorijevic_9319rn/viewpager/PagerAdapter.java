...
public class PagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        Fragment fragment;
        switch (position) {
            case FRAGMENT_1: fragment = new Stanje_Fragment(); break;
            case FRAGMENT_2: fragment = new Unos_Fragment(); break;
            case FRAGMENT_3: fragment = new Liste_Fragment(); break;
            default: fragment = new Profil_Fragment(); break;
        }
        return fragment;
    }
